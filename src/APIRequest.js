...
var APIRequest = /** @class */ (function () {
    function APIRequest(route, fetchOptions, requestOptions) {
        /**
         ...
         */
        this.fetchSuccess = undefined;
        this.route = route;
        this.options = fetchOptions;
        this.id = ++APIRequest.lastId;
        this.timeout = (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeout) || 10000;
        this.maxAttempts = (requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.maxAttempts) || 3;
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, node_fetch_1["default"](this.route, __assign({}, this.options))];
                    case 1:
                        res = _a.sent();
    ...
    APIRequest.prototype.hasSucceeded = function () {
